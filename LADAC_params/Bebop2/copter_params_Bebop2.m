%  ** Parameter file of quadcopter Parrot Bebop 2 **
% values are based on:
% G. Silano, P. Oppido and L. Iannelli, "Software-in-the-loop simulation for improving flight control system design: a quadrotor case study," 2019 IEEE International Conference on Systems, Man and Cybernetics (SMC), Bari, Italy, 2019, pp. 466-471, doi: 10.1109/SMC.2019.8914154.
% 
% Better parameters:
